    ...
    <div class="photo-bloc" 
        ...
        <div class="photo-bloc__picture">
            <a href="<?php echo get_permalink(); ?>" class="photo-bloc__picture">
                <img src="<?php echo esc_url(get_the_post_thumbnail_url()); ?>" class="photo-bloc__picture-img" alt="<?php the_title_attribute(); ?>">
            </a>
        </div>
        <div class="photo-bloc__hover <?php echo wp_is_mobile() ? 'mobile' : ''; ?>">
